...
Public Class ClientsVerified
    ...
    Private Sub ClientsVerified_Load(sender As Object, e As EventArgs) Handles Me.Load
        'for datagridview
        Try
            reloaData("SELECT id, Sname, Fname, email, phonenum, bdate FROM login WHERE verified = '1'", Guna2DataGridView1)
    ...
    Private Sub Guna2Button2_Click(sender As Object, e As EventArgs) Handles Guna2Button2.Click
        ...
        If Guna2ComboBox1.Text = "Archived" Then
                Try
